...
public class URLFormatUtility {
    private static final String NUTRITION_ROUTE = "?results=0%3A20&cal_min=0&cal_max=50000&fields=*";

    /*"?results=0%3A20&cal_min=0&cal_max=300&fields=item_name%2Cbrand_name%2Cnf_calories%2Cnf_calories_from_fat" +
